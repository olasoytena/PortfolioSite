...
function Timeline() {
    return (
        <div className="flex flex-col md:flex-row  justify-left w-full ">
            ...
            <div className="grid grid-cols-1 md:w-1/3 max-h-min bg-white mt-6 pb-4 pl-4 pr-4 pt-4 rounded-lg border-4 
            ...
            <div className="w-1/12"> </div>
            <div className="grid grid-cols-1 gap-4 md:w-1/2 bg-white mt-6 pb-4 pl-4 pr-4 pt-4 rounded-lg border-4 
